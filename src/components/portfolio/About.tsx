        ...
        <div className="bg-zinc-200 h-[48rem] text-3xl text-black py-12 border-t-4 border-solid border-black flex items-center justify-center">
            <div className="w-3/4">
                ...
                <div className="h-72 flex flex-row items-center justify-center">
                    <img
                        className="h-72 w-auto m-4 border-solid border-4 border-black"
                        src={`about4.jpg`}
                    />
                    <div className="px-10 text-xl text-left font-assistant">
                        ...
                        <p className="pt-7">Outside of web development, my greatest passions are travel and reading. I also love  
                        writing, cooking, learning languages, playing board and video games, and sleeping. And coffee. ☕</p>
                        <p className="pt-7">Looking forward to working with you!</p>
                    </div>
                </div>
            </div>
        </div>
